...
const launchHandler : Function = (responseHelper : clova.Context) => {
  ...
  responseHelper.setSimpleSpeech(clova.SpeechBuilder.createSpeechText('おはよう！鳴き声クイズへようこそ。クイズの説明を聞きますか？'));
...
app.post('/', clovaMiddleware, (clovaSkillHandler as RequestHandler));
